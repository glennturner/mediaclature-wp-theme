...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'mediaclature' ); ?></a>
	...
	<header id="masthead" class="site-header">
		...
		<nav id="site-navigation" class="main-navigation">
			<?php
				/*
			<button class="menu-toggle primary-mobile-menu" aria-controls="primary-menu" aria-expanded="false">
			...
			?>
				<?php
					// esc_html_e( 'Primary Menu', 'mediaclature' );
				?>
			<?php
			wp_nav_menu(
				array(
